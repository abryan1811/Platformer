...
std::vector<Platform> Platform::GetAllPlatforms()
{
    ...
    platforms.emplace_back(0.5f * config::tileSize, 19 * config::tileSize, 8 * config::tileSize, 0.1 * config::tileSize);

    platforms.emplace_back(16.5f * config::tileSize, 13 * config::tileSize, 13 * config::tileSize, 0.5 * config::tileSize);
